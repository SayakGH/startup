...
const NavLinks = () => {
    return (
        <>
            ...
            <HashLink className="ptext-white bg-blue-900 hover:bg-blue-800 inline-flex items-center justify-center w-auto px-6 py-3 shadow-xl rounded-xl" to="/contact#contact">
                Contact Us
            </HashLink>
